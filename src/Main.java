// Importar las clases y distribuir en paquetes
import Movilidad.*;
import Musica.*;
import TV.*;
import others.*;
// Importar la libria para ingregar datos
...
public class Main {
        public static void main(String[] args) {
            ...
            // CLASE SERIE CREACION DE OBJETOS
            ...
            // CLASE SEMANA 3 18/10/2024
            // CREACION DE LOS OBEJTOS DE LA CLASE OPERACIONES
            Operaciones numberOne = new Operaciones();
            numberOne.setN1(45.0);
            numberOne.setN2(5.0);
            numberOne.imprimirDatos();

            System.out.println(numberOne.sumatoria());
            numberOne.sumaImpresion();
            numberOne.raiz();

            // [EJERCICIO EN CLASE]
            Scanner entrada = new Scanner(System.in);
            // [MENU CALCULADORA]
            System.out.println("[CALCULADORA EPN]");
